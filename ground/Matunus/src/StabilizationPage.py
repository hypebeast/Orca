...
class StabilizationPage(QtGui.QWidget):
    ...
    def _applyValues(self):
        ...
        # PID Roll settings
        self._fmu.setPIDRollCoefficients(self.spbRollKp.value(),
                                                self.spbRollKi.value(),
                                                self.spbRollKd.value(),
                                                self.spbRollILimit.value())

        # PID Pitch settings
        self._fmu.setPIDPitchCoefficients(self.spbPitchKp.value(),
                                                self.spbPitchKi.value(),
                                                self.spbPitchKd.value(),
                                                self.spbILimitPitch.value())

        # PID Yaw settings
        self._fmu.setPIDYawCoefficients(self.spbYawKp.value(),
                                                self.spbYawKi.value(),
                                                self.spbYawKd.value(),
                                                self.spbILimitYaw.value())

        # DCM Roll settings
        self._fmu.setDcmRollCoefficients(self.spbDcmRollPitchPFactor.value(),
                                                self.spbDcmRollPitchIFactor.value())

        # DCM Pitch settings
        self._fmu.setDcmPitchCoefficients(self.spbDcmRollPitchPFactor.value(),
                                                self.spbDcmRollPitchIFactor.value())

        # DCM Yaw settings
        self._fmu.setDcmYawCoefficients(self.spbDcmYawPFactor.value(),
    ...
    def _saveValues(self):
        ...
        # Save settings
        self._fmu.saveBoardSettings()

    def _onObjectReceived(self):
