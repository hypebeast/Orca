...
void orca_board_init(BOARD_CONFIG_t *board)
{
	...
	ioport_configure_pin(BOARD_SERVO_OUT_EDF_LEFT_GPIO, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(BOARD_SERVO_OUT_EDF_RIGHT_GPIO, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(BOARD_SERVO_OUT_SERVO_LEFT, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(BOARD_SERVO_OUT_SERVO_RIGHT, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
